...
import(
	...
	"github.com/inggridpardede/go_students_crud_mysql/pkg/models"
	"github.com/inggridpardede/go_students_crud_mysql/pkg/utils"
)
var NewStudent models.Student
func GetStudent(w http.ResponseWriter, r * http.Request) {
	newStudents: = models.GetAllStudents()
	res,
	_: = json.Marshal(newStudents)
...
func GetStudentById(w http.ResponseWriter, r * http.Request) {
	...
	NIM,
	err: = strconv.ParseInt(studentId, 0, 0)
	if err != nil {
		fmt.Println("error while parsing")
	}
	studentDetails,
	_: = models.GetStudentbyId(NIM)
	res,
	_: = json.Marshal(studentDetails)
	w.Header().Set("Content-Type", "pkglication/json")
	w.WriteHeader(http.StatusOK)
	w.Write(res)
}
